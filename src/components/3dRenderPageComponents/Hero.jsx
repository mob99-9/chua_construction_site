...
{/* Top Gradient */}
<div className="absolute inset-x-0 top-0 z-20 h-24 md:h-40 bg-gradient-to-b from-[#483832]/55 via-[#483832]/25 to-transparent" />

{/* Bottom Gradient */}
<div className="absolute inset-x-0 bottom-0 z-20 h-28 md:h-44 bg-gradient-to-t from-[#483832]/60 via-[#483832]/20 to-transparent" />
